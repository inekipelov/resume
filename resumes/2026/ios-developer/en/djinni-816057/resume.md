...
Senior iOS developer with deep experience building and shipping iOS and iPadOS products across unified communications, insurance, hardware-integrated enterprise workflows, and App Store applications. Strong hands-on background in Swift, Objective-C, UIKit, SwiftUI, Combine, testing, API integration, and technically complex mobile delivery.

Experience includes secure authentication flows, backend-mobile collaboration, performance-oriented optimization, App Store release support, and long-term maintenance of production applications. Has led architecture work, delivered reusable mobile modules, improved code quality and release stability, and mentored engineers in remote product teams.

## Skills

- Languages: Swift, Objective-C, C++, JavaScript
- iOS Development: iOS, iPadOS, UIKit, SwiftUI, Combine, Core Data, SwiftData, Swift Concurrency, CoreGraphics
- Security and Integration: CryptoKit, LocalAuthentication, Keychain Services, REST APIs, WebSockets, Socket.IO, APNs
- Quality and Delivery: XCTest, Swift Testing, Git, Gitflow, CI/CD, App Store release workflows
